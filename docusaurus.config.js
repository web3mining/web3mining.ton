...
const config = {
  ...
  url: "https://web3mining.github.io",
  // Set the /<baseUrl>/ pathname under which your site is served
  // For GitHub pages deployment, it is often '/<projectName>/'
  baseUrl: "/web3mining.ton/",

  // GitHub pages deployment config.
  // If you aren't using GitHub pages, you don't need these.
  organizationName: "web3mining", // Usually your GitHub org/user name.
  projectName: "web3mining.ton", // Usually your repo name.
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl: "https://github.com/web3mining/web3mining.ton/tree/main/",
        },
        blog: {
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: "https://github.com/web3mining/web3mining.ton",
            label: "GitHub",
            position: "right",
          },
        ],
